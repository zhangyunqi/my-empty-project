document.write("<script language='javascript' src='/js/jquery.min.js?v=2.1.4'></script>");
document.write("<script language='javascript' src='/js/bootstrap.min.js?v=3.3.6'></script>");
document.write("<script language='javascript' src='/js/plugins/metisMenu/jquery.metisMenu.js'></script>");
